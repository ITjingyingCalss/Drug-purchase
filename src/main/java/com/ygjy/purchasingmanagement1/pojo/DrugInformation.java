...
public class DrugInformation implements Serializable {
    ...
    public DrugInformation(Integer id, Integer serialNumber, String commonName, Integer dosageFormId, String specification, String conversionFraction, String enterpriseName, String tradeName, Float biddingPrice, String unit, String commonNamePinyin, String productPicture, String approvalNumber, String validityOfApprovalNumber, Integer importedDrug, String packagingMaterial, String packingUnit, Float latestRetailPrice, String sourceOfRetailPrice, Integer qualityLevelId, String qualityLevelDescription, Integer drugInspectionReport, String drugInspectionReportNumber, Date validityOfDrugInspectionReport, String descriptionOfProducts, String drugCategory, Integer drugTransactionStatusId, Integer delState) {
        this.id = id;
