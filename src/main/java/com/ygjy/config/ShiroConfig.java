...
*/
 ...
 /*       *
        ...
        filterMap.put("/systemmanagement/user_control","authc");
        /*filterMap.put("/user/update","perms[user:update]");*/
        //通配符模式
        /*filterMap.put("/user/*","authc");*/
        /*filterMap.put("/purchasingmanagement1/*","authc");
        filterMap.put("/purchasingmanagement2/*","authc");
        filterMap.put("/supervision/*","authc");
        filterMap.put("/supplymanagement/*","authc");
        filterMap.put("/systemmanagement/*","authc");*/
