 ...
 * @author 
 */
public class HospitalTransactionReturnVo implements Serializable {
    /**
     * 退货单编号
     */
    ...
    public void setReturnStateId(String returnStateId) {
    ...
    public boolean equals(Object that) {
        ...
        HospitalTransactionReturnVo other = (HospitalTransactionReturnVo) that;
        return (this.getReturnOrderNumber() == null ? other.getReturnOrderNumber() == null : this.getReturnOrderNumber().equals(other.getReturnOrderNumber()))
