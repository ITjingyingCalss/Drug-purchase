...
public class PurchaseOrder implements Serializable {
    ...
    public PurchaseOrder(Integer id, String purchaseOrderNumber, String nameOfPurchaseOrder, Integer hospitalId, String contacts, String phone, Date createReceiptsTime, Date lastModificationTime, Date submissionTime, String remark, Integer purchaseState, String auditPerson, String auditOpinion, String hospitalName, Date auditTime, Integer delState) {
        this.id = id;
